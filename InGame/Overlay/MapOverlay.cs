...
public class MapOverlay
{
    ...
    private readonly Rectangle _recMap = new(8, 0, 144, 144);
    private readonly Rectangle _recHide = new(167, 103, 9, 9);
    private readonly Rectangle _recIcon = new(161, 1, 30, 30);

    private Point _selectionPosition;
    private Point _iconPosition;

    private Animator _animationPlayer = new();
    private Animator _animationSelection = new();
    ...
    private readonly bool _fullMap;
