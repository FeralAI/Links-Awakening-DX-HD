...
internal class ObjCockParticle : GameObject
{
    ...
    private readonly Color _color0 = new(57, 0, 189);
    private readonly Color _color1 = new(255, 181, 49);
    ...
    private readonly float _startRadiants;
    ...
    public ObjCockParticle(Map.Map map, Vector2 endPosition) : base(map)
    {
        ...
        for (var i = _circleCenters.Length - 2; i >= 0; i--)
        {
        ...
        for (var i = 0; i < _circleRadians.Length; i++)
        {
            if (i % 2 == Direction)
