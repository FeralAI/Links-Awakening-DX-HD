...
class MBossTurtleRock : GameObject
{
    ...
    private readonly List<GameObject> _spriteList = [];
    ...
    private readonly Vector3[] _partPosition = new Vector3[6];
    private readonly Vector3[] _partVelocity = new Vector3[6];
    private readonly int[] _partBreakOrder = new[] { 0, 5, 3, 4, 1, 2 };
