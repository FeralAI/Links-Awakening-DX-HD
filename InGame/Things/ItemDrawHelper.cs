...
class ItemDrawHelper
{
    ...
    private static readonly int _hearthDistance = 1;
    private static readonly int _heartsDistance = 1;
    ...
    private static readonly int _paddingHud = 4;

    private static Color _relictColorOne = new(0, 135, 115);
    private static Color _relictColorTwo = new(255, 255, 255);

    public static Color[] CloakColors = { new(16, 173, 66), new(24, 132, 255), new(255, 8, 41) };

    private static Rectangle _recRelicts = new(224, 128, 16, 16);
