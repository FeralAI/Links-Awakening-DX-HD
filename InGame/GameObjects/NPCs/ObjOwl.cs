...
internal class ObjOwl : GameObject
{
    ...
    private readonly CPosition _owlPosition;

    // https://cubic-bezier.com/#.17,.67,.83,.67
    private readonly CubicBezier _landingCurve = new(100, new Vector2(0.35f, 1f), new Vector2(0.8f, 1));
    private readonly CubicBezier _leavingCurve = new(100, new Vector2(0.25f, 0.04f), new Vector2(0.35f, 0.11f));
    ...
    private readonly int _enterTime = 2000;
    ...
    private readonly bool _hoverMode;
    private double _hoverCounter;

    private readonly bool _sitMode;
    private readonly int _mode; // 0: leave after talking; 1: stay after talking; 2: spawn from the top
