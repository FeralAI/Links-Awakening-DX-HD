...
{
    private readonly InterfaceButton _capsLockButton;
    private readonly InterfaceButton[,] _keyboardButtons;
    private readonly InterfaceListLayout[] _keyboardRows;
    ...
    private readonly char[,] _charactersUpper = new char[,]
    {
        { 'Q', 'W', 'E', 'R', 'T', 'Y', 'U', 'I', 'O', 'P' },
        { 'A', 'S', 'D', 'F', 'G', 'H', 'J', 'K', 'L', '-' },
    ...
    public NewGamePage(int width, int height)
    {
...

        {
            ...
            for (var y = 0; y < _charactersUpper.GetLength(0); y++)
            {
                ...
                for (var x = 0; x < _charactersUpper.GetLength(1); x++)
                {
