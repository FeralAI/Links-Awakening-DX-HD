...
internal class ObjLinkFishing : GameObject
{
    ...
    private readonly Rectangle _hookSource = new(384, 210, 16, 13);
    private readonly Rectangle _hookSourceHooked = new(389, 211, 8, 8);
    private readonly Vector2 _hookStartPosition = new(117, 40);
