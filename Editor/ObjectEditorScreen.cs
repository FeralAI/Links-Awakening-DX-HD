...
class ObjectEditorScreen(EditorCamera camera)
{
    enum Mode
    {
        Draw,
    ...
    private readonly ObjectSelectionScreen _objectSelectionSelectionScreen = new();
    ...
    private readonly EditorCamera _camera = camera;
    ...
    public Point MouseMapPosition => new(
