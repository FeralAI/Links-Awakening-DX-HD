...
internal class SpriteAtlasScreen(string screenId) : InGame.Screens.Screen(screenId)
{
    private readonly EditorCamera _camera = new();

    private readonly SpriteAtlasSerialization.SpriteAtlas _spriteAtlas = new();
    ...
    private readonly List<int> _moveEntries = [];
