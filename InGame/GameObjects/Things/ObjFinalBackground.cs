...
public class ObjFinalBackground : GameObject
{
    ...
    private readonly List<CloudPart> _clouds = [];
    private readonly List<StarAnimation> _stars = [];

    private readonly DictAtlasEntry _cloudSprite;
    private readonly CPosition _spawnPosition;

    private readonly string _moveStarKeys;
    private readonly float _moveHeight;
    private readonly float _positionTop;
