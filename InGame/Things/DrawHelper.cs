...
class DrawHelper
{
    ...
    public struct VertexPositionPositionColorTexture(
        Vector2 position, Vector2 textureCoordinate, Vector2 upperLeftPosition, Vector2 sourceSize, Color color) : IVertexType
    {
        public Vector2 Position = position;
        public Vector2 TextureCoordinate = textureCoordinate;
        public Vector2 UpperLeftPosition = upperLeftPosition;
