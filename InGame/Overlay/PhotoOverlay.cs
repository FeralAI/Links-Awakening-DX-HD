...
class PhotoOverlay
{
    ...
    private readonly DictAtlasEntry[] _spritePhotos = new DictAtlasEntry[12];
    private readonly bool[] _unlockState = new bool[12];
    ...
    private readonly float _cursorTime = 200f;
