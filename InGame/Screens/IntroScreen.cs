...
public class IntroScreen(string screenId) : Screen(screenId)
{
    ...
    private readonly Animator[] _thunder = new Animator[2];
    private readonly Vector2[] _thunderPositions = new Vector2[2];
    private readonly float[] _thunderCounts = { 1000, 2000 };
    ...
    private readonly MarinState[] _marinStates =
    {
    ...
    private readonly int[] _marinTimes = {
        1000, 1100, 900, 1300, 200, // stand times
        2000, 500, 2100, 200, 400, 200, 250, 750 // push hold times
    };

    private readonly Vector2[] _marinGoalPositions =
    {
        new(-150, 219), new(-94, 219), new(-72, 219), new(-64, 219),
        new(-18, 219)
    };
    ...
    private readonly Rectangle _oceanCloudRectangle = new(0, 0, 32, 32);
    private int _thunderIndex;
    private float _thunderCount = 250;
    private float _thunderTransition;

    private readonly Rectangle _ocean0Rectangle = new(0, 288, 32, 16);
    private readonly Rectangle _ocean1Rectangle = new(0, 304, 32, 16);
    private readonly Rectangle _ocean2Rectangle = new(0, 320, 32, 16);
    private readonly Rectangle _oceanRectangle = new(0, 144, 32, 32);
    ...
    private readonly Vector2[] _lightPositions =
    {
        new(7, 0),
        new(41, 0),
        new(2, 19),
    ...
    private readonly int _screenWidth = 160;
    private readonly int _screenHeight = 144;

    private readonly float StrandFadeTime = 600;
