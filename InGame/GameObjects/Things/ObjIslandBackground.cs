...
{
    class Cloud(int index, Vector2 position)
    {
        public int Index = index;
        public float LiveCounter = Game1.RandomNumber.Next(5000, 50000);
        public float Transparency = 1;
        public Vector2 Position = position;
    }

    private readonly Rectangle[] cloudSourceRectangles = new Rectangle[3];
    ...
    private readonly Color _colorSky = new(65, 90, 255);
    private readonly Color _colorOceanBright = new(66, 89, 255);
    ...
    private readonly int _topWaveSpeed = 250;
