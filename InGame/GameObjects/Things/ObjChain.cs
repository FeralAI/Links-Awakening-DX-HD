...
{
    class Chain(Vector2 startPosition, Vector2 endPosition)
    {
    ...
    private readonly ObjSprite[] _objChains = new ObjSprite[ChainCount - 1];
    private readonly Chain[] _chains = new Chain[ChainCount];

    private float _chainLength;
    private readonly float _chainLengthInit = 7.5f;
    private readonly float _chainLengthEnd = 4f;
