...
{
    private readonly Dictionary<string, bool> _boolDictionary = [];
    private readonly Dictionary<string, int> _intDictionary = [];
    ...
    private readonly Stack<HistoryFrame> _history = new();
    ...
    {
        _stringDictionary.TryGetValue(key, out var outString);
        return outString;
    }
