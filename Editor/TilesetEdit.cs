...
internal class TilesetEdit(string screenId) : InGame.Screens.Screen(screenId)
{
    ...
    private readonly List<MapData> _loadedMaps = [];
    private readonly List<Tile> _tileSetData = [];
