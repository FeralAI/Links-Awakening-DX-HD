...
internal class ObjItem : GameObject
{
    ...
    private readonly AiTriggerCountdown _delayCountdown;
    private readonly BodyDrawComponent _bodyDrawComponent;
    private readonly CRectangle _collectionRectangle;

    private Rectangle _sourceRectangle;
    private Rectangle _sourceRectangleWing = new(2, 250, 8, 15);

    private Color _color = Color.White;
    private Rectangle _shadowSourceRectangle = new(0, 0, 65, 66);

    private float _fadeOffset;

    private double _deepWaterCounter;
    private float _despawnCount;
    private readonly int _despawnTime = 350;
    private readonly int _fadeStart = 250;
    private readonly int _moveStopTime = 250;
    private int _lastFieldTime;

    private readonly bool _isFlying;
    private readonly bool _isSwimming;
