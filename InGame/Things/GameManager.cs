...
public class GameManager
{
    ...
    public OverlayManager InGameOverlay = new();
    ...
    public List<GameItemCollected> CollectedItems = [];

    // sound effects that are currently playing
    private readonly Dictionary<string, PlayingSoundEffect> CurrentSoundEffects = [];

    // dungeon maps
    public Dictionary<string, MiniMap> DungeonMaps = [];

    public Dictionary<Type, GameSystem> GameSystems = [];
    ...
    private readonly Queue<string> _dialogPathQueue = new();
    ...
    private readonly int[] _musicArray = new int[MusicChannels];
    // counters used to stop music
    private readonly float[] _musicCounter = new float[MusicChannels];
