...
{
    private readonly ObjStone[] _objPots = new ObjStone[4];
    private readonly float[] _potCounter = new float[4];
    private readonly bool[] _potIsActive = new bool[4];

    private readonly Vector2[] _potPositions = { new(-4, -2), new(3, 3), new(-4, 3), new(3, -2) };
    private readonly Vector2[] _tilePositions =
    {
        new(-4, -1), new(-4, 0), new(-4, 1), new(-4, 2),
        new(3, -1), new(3, 0), new(3, 1), new(3, 2),
        new(-3, -2), new(-2, -2), new(-1, -2), new(0, -2), new(1, -2), new(2, -2),
        new(-3, 3), new(-2, 3), new(-1, 3), new(0, 3), new(1, 3), new(2, 3)
    };
