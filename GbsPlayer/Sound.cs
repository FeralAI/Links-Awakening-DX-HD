...
public class Sound
{
    ...
    private readonly byte[] _soundBuffer = new byte[(OutputRate / 100) * 2]; // 100 buffers per second
    private int _bufferIndex;

    // FF10-FF3F
    private readonly byte[] _soundRegister = new byte[0x30];
    ...
    private readonly byte[] _waveNibbles = new byte[32];
