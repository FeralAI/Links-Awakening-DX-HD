...
class ObjArrow : GameObject
{
    ...
    private readonly Vector2[] _bombOffset = new Vector2[] { new(-4, 0), new(0, -4), new(4, 0), new(0, 6) };
    private ObjBomb _objBomb;
    private bool _bombMode;

    private Vector2 _startPosition;
    private readonly Point[] _collisionBoxSize = { new(2, 2), new(2, 2), new(2, 2), new(2, 2) };
