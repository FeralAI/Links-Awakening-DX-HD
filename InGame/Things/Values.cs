...
{
    public static string VersionString = "v1.1.0-alpha.1";
    ...
    public static Color MenuButtonColor = new(40, 64, 128);
    public static Color MenuButtonColorSelected = new(112, 144, 216);
    public static Color MenuButtonColorSlider = new(40, 64, 128);
    ...
    public static Color GameMenuBackgroundColor = new(255, 255, 255, 255);
    ...
    public static Color TextboxBlurColor = new(255, 255, 255, 255);
    public static Color TextboxFontColor = new(248, 248, 136);

    public static Color MapTransitionColor = new(0, 0, 0, 255);
    public static Color MapFirstTransitionColor = new(20, 20, 20, 255);

    public static Color OverlayBackgroundColor = new Color(255, 255, 190) * 0.55f;
    public static Color OverlayBackgroundBlurColor = new(255, 255, 255, 255);

    public static Color[] SkirtColors = { new(16, 168, 64), new(0, 38, 255), new(255, 0, 0) };
