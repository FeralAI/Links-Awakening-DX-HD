...
class BossMoldorm : GameObject
{
    ...
    private Rectangle _headSourceRectangle = new(2, 4, 28, 24);
    private Rectangle _headSourceRectangleDamage = new(34, 4, 28, 24);

    private readonly Rectangle[] _tailRectangles = {
        new(8, 40, 16, 16), new(8, 40, 16, 16), new(41, 41, 14, 14)
    };
    private readonly Rectangle[] _tailRectanglesDamage = {
        new(8, 72, 16, 16), new(8, 72, 16, 16), new(41, 73, 14, 14)
    };

    private readonly Vector2[] _tailPositions = new Vector2[4];
    private readonly float[] _tailDistance = { 6.5f, 4.5f, 4.5f, 4.5f };

    private readonly Vector2[] _savedPosition = new Vector2[20];

    private readonly string _saveKey;
    private readonly string _triggerKey;

    private readonly float _saveInterval = 33;
