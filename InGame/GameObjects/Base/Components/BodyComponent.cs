...
public class BodyComponent(CPosition position, int offsetX, int offsetY, int width, int height, int depth) : Component
{
    ...
    public CBox BodyBox = new CBox(position, offsetX, offsetY, width, height, depth);
