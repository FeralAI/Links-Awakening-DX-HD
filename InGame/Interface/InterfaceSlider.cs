...
public class InterfaceSlider : InterfaceElement
{
    ...
    private static readonly int _scrollStartTime = 350;
    private static readonly int _scrollTime = 75;

    private Color _colorSlider;
    private Color _colorSliderBackground = new(79, 79, 79);
