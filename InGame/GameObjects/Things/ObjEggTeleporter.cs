...
{
    private readonly List<GameObject> _bodyObjects = [];
    ...
    private readonly RoomState[,] RoomStates = new RoomState[4, 5];
    private readonly RoomState[,] tempRoomStates = new RoomState[4, 5];
    ...
    private readonly float lightSpeed = 0.065f;
    private readonly float darknessSpeed = 0.08f;
    private readonly float tLit = 0;
    private readonly float tDark = 1;
    private readonly float tLightBleed = 0.845f;

    private readonly int[] _movedPath = new int[7];
    private int _pathIndex;

    private readonly int[] _targetPath = new int[7];
