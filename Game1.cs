...
public class Game1 : Game
{
    ...
    public static UiManager EditorUi = new();
    public static ScreenManager ScreenManager = new();
    public static PageManager UiPageManager = new();
    public static GameManager GameManager = new();
    public static Language LanguageManager = new();

    public static GbsPlayer.GbsPlayer GbsPlayer = new();

    public static StopWatchTracker StopWatchTracker = new(120);
    public static Random RandomNumber = new();
    ...
    private static readonly DoubleAverage _avgTotalMs = new(30);
    private static readonly DoubleAverage _avgTimeMult = new(30);
    ...
    private readonly float _blurValue = 0.2f;

    private readonly SimpleFps _fpsCounter = new();
    ...
    private readonly double[] _debugFrameTimes =
    {
        1000 / 30.0,
        1000 / 60.0,
        1000 / 90.0,
