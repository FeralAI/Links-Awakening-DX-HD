...
class FinalSequence : GameSequence
{
    ...
    private readonly float ScreenFadeTime = 250;
    private readonly float ScreenFadeTimeWait = 500;
    ...
    private readonly SeqAnimation[] _s4Water = new SeqAnimation[24];
    ...
    private void InitScreen4()
    {
        ...
        // animated water
        for (var i = 0; i < _s4Water.Length; i++)
    ...
    private void UpdateScreen1()
    {
        ...
        var percentage = MathF.Sin(_fadeCounter / FadeTime);
